...
class QuestionForm extends React.Component {
  ...
  syncQuestion = () => {
    ...
    question.answers = this.state.correctOptionsIndex.map((optionIndex, i) => {
  ...
  updateQuestion = () => {
    ...
    // dispatch.
    this.props.dispatch(updateQuestion(this.props.question._id, { question }));
      ...
      <div className="shadow p-3 mb-5 bg-white rounded">
        <div className="form-row">
          <div className="form-group col-md-12">
            {this.props.isInvalidQuestion || this.state.isInvalidQuestion ? (
              <div class="alert alert-danger" role="alert">
                Question should have title and all options filled and atleast
                one correct answer.
              </div>
            ) : null}
                    ...
                    <div className="input-group-prepend">
                      <div className="input-group-text">
                        <input
                          ...
                          checked={this.state.correctOptionsIndex.includes(i)}
                          type="checkbox"
